...
\usepackage{graphicx,amsmath,color,listings,float}
...
\lstset{
	...
	breaklines,
	numbers=left,
	morekeywords={begin, end, function, references, boolean, localtimestamp, returns, serializable}
}

\subsection{Создание таблиц}
\lstinputlisting{create_db.sql}

\subsection{Создание представлений, функций и триггеров}
\lstinputlisting{create_fnc.sql}
